...
public class MessageConst {
    ...
    public static final String START_GAME_MSG = "숫자야구 개임을 시작합니다.";
    ...
    public static final String  INPUT_LENGTH_EXCEPTION = NumberConst.INPUT_LENGTH + "글자를 입력하세요";

    public static final String  INPUT_RANGE_EXCEPTION = NumberConst.FIRST_RANGE +" ~" + NumberConst.LAST_RANGE + "사이의 값을 입력하세요";

    public static final String INPUT_DUPLICATE_EXCEPTION = "중복된 숫자는 입력할 수 없습니다.";
