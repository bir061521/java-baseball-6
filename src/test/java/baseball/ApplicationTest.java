...
class ApplicationTest extends NsTest {
    ...
    void 사용자_입력_길이_테스트() {
        ...
        assertThatThrownBy(() ->
                ...
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining(MessageConst.INPUT_LENGTH_EXCEPTION);
    ...
    void 사용자_입력_범위_테스트() {
        ...
        assertThatThrownBy(() ->
                ...
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining(MessageConst.INPUT_RANGE_EXCEPTION);
    }
    ...
    void 사용자_입력_중복_테스트() {
        ...
        assertThatThrownBy(() ->
                ...
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining(MessageConst.INPUT_DUPLICATE_EXCEPTION);
    }
